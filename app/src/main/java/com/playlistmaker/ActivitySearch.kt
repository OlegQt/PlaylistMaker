...
class ActivitySearch : AppCompatActivity() {
    ...
    private var lstMusic:RecyclerView? = null
    private var lstTracks: ArrayList<Track> = ArrayList()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Создаем адаптер
        lstMusic = findViewById(R.id.search_recycle_view)
        val musLayOut = LinearLayoutManager(this)
        musLayOut.orientation = RecyclerView.VERTICAL
        lstMusic?.layoutManager=musLayOut
        lstMusic?.adapter = SearchTrackAdapter(this.fillTrackList())
